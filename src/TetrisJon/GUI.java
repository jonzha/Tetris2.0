...
public class GUI extends JPanel implements ChangeListener,
	...
	public GUI(String weight, int sliderMin, int sliderMax) {
		...
		slider = new JSlider(sliderMin, sliderMax, randInt2(sliderMin,
				sliderMax));

		// Slider
		slider.addChangeListener(this);
		slider.setMajorTickSpacing((sliderMax - sliderMin) / 4);
		slider.setMinorTickSpacing((sliderMax - sliderMin) / 10);
		...
		textField.setText("" + new Double(slider.getValue()));
	...
	public void stateChanged(ChangeEvent e) {
		...
		double textValue = (double) source.getValue();
